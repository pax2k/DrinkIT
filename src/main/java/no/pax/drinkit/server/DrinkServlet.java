...
public class DrinkServlet extends HttpServlet {
    ...
    private final Map<String, DrinkITWebSocket> _members = new ConcurrentHashMap<String, DrinkITWebSocket>();
            ...
            try {
                ...
                if (Util.SERVER_NAME.equals(to)) {
                    ...
                    if (!_members.containsKey(regestrationObject)) { // todo handle update AKA refresh
                        ...
                        final String sendStringAsJSon = Util.getSendStringAsJSon(Util.WEB_VIEW_WATER_CLIENT, Util.SERVER_NAME, "OK");
                    ...
                    final DrinkITWebSocket drinkITWebSocket = _members.get(to);

                    if (drinkITWebSocket != null) {
                        sendDataToClients(drinkITWebSocket._connection, data);
                    } else {
